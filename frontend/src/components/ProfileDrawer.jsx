...
const ProfileDrawer = () => {
    const { isProfileDrawerOpen, setIsProfileDrawerOpen, user, headerHeight, myOrders, logOut } = useShop();
            ...
            {isProfileDrawerOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className={`fixed profile-card shadow-xl z-1000 flex flex-col
                
                /* MOBILE SETTINGS */
                bottom-0 left-0 right-0 w-full rounded-t-2xl h-[85vh]
                                ...
                                {user ? (
                                    <div className="p-6 flex flex-col h-full bg-white">
                                        ...
                                        <nav className="space-y-4">
                                            <button className="nav-link-editorial">My Library Orders</button>
                                            ...
                                            {user.role === "admin" && (
                                                <button className="nav-link-editorial text-secondary font-bold underline">
                                                    Go to Shop Manager
                                                </button>
                                            )}
                                        </nav>
